...
extern LIB_libcompcur_CPP_API void MW_CALL_CONV compute_curvature(int nargout, mwArray& Umax, mwArray& Umin, mwArray& Cmax, mwArray& Cmin, mwArray& Normal, mwArray& hks, mwArray& diameter, const mwArray& V, const mwArray& F, const mwArray& off_filename, const mwArray& hks_len);
