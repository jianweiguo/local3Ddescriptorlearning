...
namespace GIGen
{
    ...
    struct VPropHandles
    {
        ...
        OpenMesh::VPropHandleT<Point> u_max, u_min, normal;
        OpenMesh::VPropHandleT<vector<double>> hks;
    };
    ...
    public:
        ...
        MeshOM(const std::string& filename, const int &hks_len = 16)
        {
        ...
        {
            //auto &u_max_ = vphs.u_max;
            //auto &u_min_ = vphs.u_min;
            //auto &c_max = vphs.c_max;
            //auto &c_min = vphs.c_min;
            //auto &n = vphs.normal;
            //auto &hks_ = vphs.hks;
            ...
            compute_curvature(7, u_max, u_min, curvature_max, curvature_min, normal, hks, diameter, vertices, faces, filenameArray, desc_len);
