...
namespace GIGen
{
    ...
    public:
        GPC(Mesh &mesh_, const unsigned int &source_idx_, const double &computation_max_radius_) :
            mesh(mesh_), source_idx(source_idx_), computation_max_radius(computation_max_radius_), gpc_gen(mesh)
        {
            ...
            //std::cout << "----------------------------" << std::endl << "computation_max_radius: " << computation_max_radius << std::endl << "----------------------------" << std::endl;
