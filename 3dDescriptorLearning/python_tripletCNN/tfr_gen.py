...
parser.add_argument('--tfr_dir', '-d',
                    # default='/media/disk_add/hywang/project/3dDescriptor2018/dataset/faust/gi_TFRecords',
                    type=str, help='directory to store TFRecords')
parser.add_argument('--gi_dir', '-s',
                    # default='/media/disk_add/hywang/project/3dDescriptor2018/dataset/faust/gi_classified',
