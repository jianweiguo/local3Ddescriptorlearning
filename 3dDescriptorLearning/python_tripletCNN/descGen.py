...
# parser.add_argument('--restore_path', default='/media/disk_add/hywang/project/3dDescriptor2018/train/train_mincv_20180514/saved_models/training_model-57499', 
parser.add_argument('--restore_path', default='/media/disk_add/hywang/project/3dDescriptor2018/train/train_mincv_finetune_20180520_gap_2/saved_models/training_model-67499', 
                    type=str, 
...
parser.add_argument('--gi_dir', '--gd', default='/media/disk_add/hywang/project/3dDescriptor2018/dataset/faust_test_allpoints', 
                    type=str, help='root directory of gi files')
parser.add_argument('--desc_dir', '--dd', default='/media/disk_add/hywang/project/3dDescriptor2018/evaluation/faust/ours/descs_finetune_gap_2_0520_67499', 
